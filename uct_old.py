...
for episode in range(total):
    ...
    utility = 0
    reward = 0
    steps = 20000000 # each game goes 200 steps
    for step in range(steps):
        ...
        for i in range(k):
            ...
            for trial_step in range(trial_steps):
                running_gamma = running_gamma * gamma
                ...
                # trial_reward = m2 - m1
                trial_utility = trial_utility + running_gamma * trial_reward
        ...
        if done:
            print("Episode finished after {} time steps".format(step))
            break
env.close()
